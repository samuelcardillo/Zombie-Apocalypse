...
/***/ function(module, exports) {
	...
	AFRAME.registerComponent('controller-cursor', {
	  ...
	  play: function () {
	    ...
	    cursorEl.addEventListener('gripdown', this.onTriggerDownBind);
	    cursorEl.addEventListener('gripup', this.onTriggerUpBind);
	  },
	  ...
	  pause: function () {
	    ...
	    cursorEl.removeEventListener('raycaster-intersection-cleared',
	                                 this.onIntersectionClearedBind);
	    cursorEl.removeEventListener('gripdown', this.onTriggerDownBind);
	    cursorEl.removeEventListener('gripup', this.onTriggerUpBind);
	  },
